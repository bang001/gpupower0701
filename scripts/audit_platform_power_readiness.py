...
PLAN_SHELL_TERMS = [
    ...
    "run_checked schema_power_api_audit",
    "run_checked tensor_mma_binary_audit",
    "trap pipeline_error ERR",
    "PIPELINE_ABORT",
    '--cuobjdump "${CUOBJDUMP_COMMAND}"',
                ...
                if profile == "v100":
                    shell_terms.extend(
                        [
                            ...
                            "BLOCKS_PER_SM=32",
                            "REG_BLOCKS_PER_SM=4",
                            "REG_BLOCKS_PER_SM_VALUES=4,16,32",
                            "SHARED_W_SM_KIB=32",
                            "L1_W_SM_KIB=32",
