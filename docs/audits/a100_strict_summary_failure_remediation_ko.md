...
| A100 finalplan dry-run | W16/32/64/128 L2 energy matrix 42 valid commands, L2 dual-calibration 21 coordinates/42 calibration commands, primary NCU 74 cases 확인 | 실제 A100 cache hit/energy coefficient는 아직 재측정 전 |
