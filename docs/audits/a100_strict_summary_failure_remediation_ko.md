...
| A100 finalplan dry-run | NCU selector가 고른 B 하나에서 W16/32/64/128 L2 energy 24 commands/repeat, L2 dual-calibration 12 coordinates/24 calibration commands, primary NCU 79 cases와 최대 56-case selector precheck 확인 | 실제 A100 cache hit/energy coefficient는 아직 재측정 전; selector가 두 anchor에서 통과하지 않으면 energy 전에 종료 |
