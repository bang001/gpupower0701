...
모든 profile의 L2 CG와 DRAM CG pair는 동일 ITER를 강제한다. treatment의 목표
...
control power를 treatment 시간으로 늘려 빼는 duration-scaled L2/DRAM 계산은 현행
...
| energy blocks/SM | 8,16 | general 16,32; L2 selected 16/8/4 | general 4,16,32; L2 selected 32/16/4 | 16,32 | A100/V100 L2는 precheck가 고른 B 하나만 energy/full NCU에 사용 |
...
| DRAM sanity | W8192; B8,16 | W8192; B16,32 | W8192; B4,16,32 | W8192; B16,32 | KiB/SM; 총 working set이 nominal L2보다 커야 함 |
...
| primary NCU sidecar | 44 | 74 | 54 | 44 | selector precheck A100 최대 32/V100 최대 16 cases 별도 |
| strict NCU anchor B | 8 | Shared/L1 16; L2 selected 16/8/4 | Shared/L1 32; L2 selected 32/16/4 | 16 | blocks/SM |
...
| V100 | 2048 | 32,64 | 8,16,32 | 32,64 with `l2_cg_load_only` | 8192 | general energy 4,16,32; L2 selected B32/16/4 |
| A100 | 2048 | 64,128 | 16,32 | 16,32,64,128 with `l2_cg_load_only` | 8192 | general energy 16,32; L2 selected B16/8/4 |
...
| energy blocks/SM | 8,16 | 16,32 | 4,16,32 | 16,32 | blocks/SM |
| generated strict NCU blocks/SM | 8 | Shared/L1 16; L2 16/8/4 selected | Shared/L1 32; L2 32/16/4 selected | 16 | blocks/SM |
...
| A100 | selector candidate W16,32,64,128/B16,8,4 | 없음 | 두 anchor를 통과한 B 하나만 full energy에 전달 |
...
| DRAM sanity | 12 / 60 | 12 / 60 | 18 / 90 | 12 / 60 | 2 modes x blocks/SM x LR 3개 |
...
| primary NCU sidecar | 44 | 74 | 54 | 44 | cases, diagnostic mode 제외; selector precheck 별도 |
| nominal energy kernel time | 4,300 | 4,900 | 6,600 | 4,900 | s, raw rows x 10 s 기준; calibration/launch/NCU/precheck 별도 |

RTX 3090/H100의 NCU 44 cases는 `clocked_empty` 1개, Tensor treatment/control
...
V100은 L2 W32/W64 두 점을 수집하여 총 54 cases다. 이 수에는 selector의 조기
...
energy/full NCU에 사용하며, raw row는 660개다.
...
정책이 기록된다. A100은 normal `.cg` policy가 strict L2 hit를 충족하지 못할 때만
