...
V100 package는 Tensor에만 `blocks/SM=4,16,32`를 사용하고 Shared/Global-L1/external은
energy와 strict NCU 모두 B32를 쓴다. L2는 energy 전에 normal contiguous B32와 sm-interleaved B32/B16/B4를
W32/W64에서 검사하고 첫 strict-pass B만 energy/minimal coherent L2 NCU에 사용한다. V100 CC 7.0에는
...
Tensor static audit의 `cuobjdump`는 선택한 `NVCC`와 같은 toolkit에서
가져오며, 필요하면 `CUOBJDUMP`로 절대 경로를 지정한다.
...
|---|---|---:|---:|---:|---:|---:|---|
| RTX 3090 | Tensor 4,8,16; memory 8 | 72 count | 360 rows | 15 / 30 | 6 / 12 | 73 cases | L2 W32/W64/B8 exact NCU |
| A100 | Tensor 4,16,32; memory 16; L2 selected B1/2/4/8/16 | 72 count | 360 rows | 15 / 30 | 6 / 12 | 73 + up to 56 precheck | W16/W128 selector 통과 필요 |
| V100 | Tensor 4,16,32; memory 32; L2 selected B4/16/32 | 72 count | 360 rows | 15 / 30 | 6 / 12 | 73 + up to 16 precheck | W32/W64 selector 통과 필요 |
| H100 SXM5 | Tensor 4,16,32; memory 16; L2 selected B8/16 | 72 count | 360 rows | 15 / 30 | 6 / 12 | 73 + up to 24 precheck | W64/W128 fabric-aware selector |
...
| dashboard | 목적 |
|---|---|
| `results/summary/platform_component_intake_dashboard_20260716.md` | RTX 3090/V100/A100/H100 package 상태, 첫 open stage, strict summary 상태, goal readiness pass/missing/fail 요약 |

| GPU | package audit | gap report |
|---|---|---|
| A100 | `results/summary/a100_platform_result_package_audit_20260716.md` | `results/summary/a100_platform_result_package_gaps_20260716.md` |
| V100 | `results/summary/v100_platform_result_package_audit_20260716.md` | `results/summary/v100_platform_result_package_gaps_20260716.md` |
| H100 | `results/summary/h100_platform_result_package_audit_20260716.md` | `results/summary/h100_platform_result_package_gaps_20260716.md` |
