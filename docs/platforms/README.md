...
|---|---|---|---|
| RTX 3090 | `results/summary/rtx3090_component_finalplan_20260714_command_plan.md` | `results/summary/rtx3090_component_finalplan_20260714_commands.sh` | 실행 후 생성 |
| A100 | `results/summary/a100_component_finalplan_20260714_command_plan.md` | `results/summary/a100_component_finalplan_20260714_commands.sh` | 실행 후 생성 |
| V100 | `results/summary/v100_component_finalplan_20260714_command_plan.md` | `results/summary/v100_component_finalplan_20260714_commands.sh` | 실행 후 생성 |
| H100 | `results/summary/h100_component_finalplan_20260714_command_plan.md` | `results/summary/h100_component_finalplan_20260714_commands.sh` | 실행 후 생성 |
