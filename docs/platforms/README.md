...
| A100 | 16,32 | 116 count | 580 rows | 10 / 20 | 21 / 42 | 74 cases | L2 W16,32,64,128 NCU plateau 선택 후 target-node acceptance 필요 |
| V100 | 4,16,32 | 156 count | 780 rows | 15 / 30 | 18 / 36 | 44 cases | target-node acceptance 필요 |
