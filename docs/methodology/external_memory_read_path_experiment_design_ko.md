...
|---|---|---:|---|---|---|
| RTX 3090, 82 SM | GDDR6X, off-package | 6 | 256, 512, 2048 | 20.5, 41, 164 | 3.42x, 6.83x, 27.33x |
| V100, 80 SM | HBM2, interposer | 6 | 256, 512, 2048 | 20, 40, 160 | 3.33x, 6.67x, 26.67x |
...
|---|---|---|---|---|
| RTX 3090 | 8 | 4, 8, 16 | 4, 8, 16 | blocks/SM, count |
| V100 | 32 | 4, 8, 16 | 4, 8, 16 | blocks/SM, count |
| A100 | 16 | 4, 8, 16 | 4, 8, 16 | blocks/SM, count |
| H100 SXM5 | 16 | 4, 8, 16 | 4, 8, 16 | blocks/SM, count |
...
| L2 final-service hit | <=10% | read의 대부분이 L2에서 끝나지 않음; A100/H100은 source+LTC-fabric logical hit 사용 |
