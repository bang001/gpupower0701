...
| Tensor reuse factor trend | `docs/assets/component_energy_method/tensor_reuse_factor_trend.svg` | RF=1,2,4,8,16 broad factor-exact NCU sweep의 Tensor MMA 증분 추이. RF1/2/4는 diagnostic으로 표시 |
