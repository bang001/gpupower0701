...
2026-07-13 fixed-RF v2 Tensor 재실행은 현행 standalone Tensor 근거로 추가했으나,
Shared/Global-L1/L2까지 포함한 전체 current-protocol table은 아직 완성되지 않았다.
...
| RTX 3090 fixed-RF v2 Tensor 결과/원시 근거 확인 | `results/summary/rtx3090_tensor_fixedrf_v2_report_20260713_ko.md` |
...
| A100 Tensor RF 음수, L2 58.5-60.1% reject, NCU replay/residency, L1 W16/B32 중단 리메디에이션 | `docs/audits/a100_strict_summary_failure_remediation_ko.md` |
| A100 Tensor/L2 targeted 재실행 계획과 policy/layout/blocks-SM fail-fast 선택 | `results/summary/a100_tensor_l2_remediation_20260710_command_plan.md`, `results/summary/a100_tensor_l2_remediation_20260710_commands.sh` |
