...
| A100 | `docs/platforms/a100_node_experiment_guide_ko.md` | `results/summary/a100_component_finalplan_20260708_commands.sh` |
...
| 결과 | 현재 지위 |
|---|---|
| RTX 3090 fixed-RF v2 Tensor | current standalone evidence; 전체 component table 아님 |
| 2026-07-08 RTX 3090 component coefficients | historical/provisional; current control/schema gate 미충족 |
| RTX 3090 DRAM 26.709-28.409 pJ/bit | provisional reporting band; accepted raw coefficient 아님 |
