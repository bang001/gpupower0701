...
- `../assets/component_energy_method/current_dram_reporting_band.png`: current RTX 3090 DRAM provisional reporting band and evidence boundary
...
It also runs `scripts/plot_dram_reporting_policy.py`, which reads the canonical
DRAM policy CSV instead of the superseded clocked-empty sanity artifact.
