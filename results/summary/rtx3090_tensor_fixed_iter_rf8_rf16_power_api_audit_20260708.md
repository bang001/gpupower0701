...
- detail CSV: `results/summary/rtx3090_tensor_fixed_iter_rf8_rf16_power_api_audit_20260708.csv`
- total rows: 20
...
| value | rows |
|---|---:|
| `nvml_total_energy` | 20 |

## Integration Method Counts

| value | rows |
|---|---:|
| `total_energy_mj_delta` | 20 |

## Measurement Scope Counts

| value | rows |
|---|---:|
| `gpu_device_total_energy_counter` | 20 |
...
|---|---:|---:|---:|
| `results/raw/rtx3090_tensor_fixed_iter_rf8_rf16_20260708.csv` | 20 | 0 | 0 |
