...
| item | value |
|---|---|
| raw CSVs | `results/raw/rtx3090_shared_paired_lr8_30s_combined_20260708.csv` |
...
| power-state audit CSVs | `results/summary/rtx3090_shared_paired_lr8_30s_combined_power_state_audit_20260708.csv` |
| min elapsed (s) | 1 |
...
|---|---:|---|---:|---:|---|---|---|---|---:|---:|---:|---:|---:|---:|---:|---|---:|---|---|
| shared_l1_scalar_path | 12 | medium-high | 12 | 0 | nvml_total_energy | total_energy_mj_delta | one_sec_average | pJ/byte | 0.714831 | 1.4147 | 1.30934 | 1.53911 | 0.235555 | 0.197931 | 0.166505 | 1.1996 - 1.44928 | 0.176838 | 0.0893538 - 0.192389 | 0.14995 - 0.18116 |
...
|---|---:|---:|---:|---:|---|---|---:|---:|---:|---|---|---|---|---:|---|---:|---:|---|---|
| shared_l1_scalar_path | 64 | 16 | 1 | 8 | shared_scalar_load_only_minus_clocked_empty | nearest-control | 143.227 | 0.0150609 | 2.00365e+14 | ncu_actual_exact | nvml_total_energy | total_energy_mj_delta | one_sec_average | 0.714831 | pJ/byte | 0.0893538 | 1.04096 | True |  |
| shared_l1_scalar_path | 64 | 16 | 1 | 8 | shared_scalar_load_only_minus_clocked_empty | nearest-control | 289.979 | 0.029622 | 2.04684e+14 | ncu_actual_exact | nvml_total_energy | total_energy_mj_delta | one_sec_average | 1.41672 | pJ/byte | 0.177089 | 1.06882 | True |  |
| shared_l1_scalar_path | 64 | 16 | 1 | 8 | shared_scalar_load_only_minus_clocked_empty | nearest-control | 288.749 | 0.0300188 | 2.00664e+14 | ncu_actual_exact | nvml_total_energy | total_energy_mj_delta | one_sec_average | 1.43896 | pJ/byte | 0.17987 | 1.0088 | True |  |
| shared_l1_scalar_path | 64 | 16 | 1 | 8 | shared_scalar_load_only_minus_clocked_empty | nearest-control | 224.947 | 0.0231605 | 2.03309e+14 | ncu_actual_exact | nvml_total_energy | total_energy_mj_delta | one_sec_average | 1.10643 | pJ/byte | 0.138304 | 1.04795 | True |  |
| shared_l1_scalar_path | 64 | 16 | 1 | 8 | shared_scalar_load_only_minus_clocked_empty | nearest-control | 260.35 | 0.0270912 | 2.01389e+14 | ncu_actual_exact | nvml_total_energy | total_energy_mj_delta | one_sec_average | 1.29277 | pJ/byte | 0.161597 | 1.03154 | True |  |
| shared_l1_scalar_path | 64 | 16 | 1 | 8 | shared_scalar_load_only_minus_clocked_empty | nearest-control | 262.074 | 0.0271945 | 2.01701e+14 | ncu_actual_exact | nvml_total_energy | total_energy_mj_delta | one_sec_average | 1.29932 | pJ/byte | 0.162415 | 1.02598 | True |  |
