...
| input | path |
|---|---|
| power API audit | `results/summary/rtx3090_l1_60s_stability_power_api_audit_20260708.csv` |
| NCU acceptance | `results/summary/rtx3090_finalplan_ncu_factor_stability_acceptance_20260708.csv` |
| matched summary | `results/summary/rtx3090_l1_60s_stability_powerstate_filtered_matched_control_summary_20260708.csv` |
| matched detail | `results/summary/rtx3090_l1_60s_stability_powerstate_filtered_matched_control_detail_20260708.csv` |
...
|---|---|---:|---|---:|---:|---:|---|---|---|
| `global_l1_hit_path` | `accepted` | 0.1191477744 | pJ/bit | 7 | 7 | 3 | `medium` | - | - |
