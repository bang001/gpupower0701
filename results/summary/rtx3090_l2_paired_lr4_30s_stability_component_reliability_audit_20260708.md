...
| input | path |
|---|---|
| power API audit | `results/summary/rtx3090_l2_paired_lr4_30s_stability_power_api_audit_20260708.csv` |
| NCU acceptance | `results/summary/rtx3090_finalplan_ncu_factor_stability_acceptance_20260708.csv` |
| matched summary | `results/summary/rtx3090_l2_paired_lr4_30s_stability_matched_control_summary_20260708.csv` |
| matched detail | `results/summary/rtx3090_l2_paired_lr4_30s_stability_matched_control_detail_20260708.csv` |
...
|---|---|---:|---|---:|---:|---:|---|---|---|
| `l2_hit_cg_path` | `accepted` | 1.02725397342 | pJ/bit | 6 | 6 | 3 | `medium` | - | - |
