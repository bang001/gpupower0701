...
- detail CSV: `results/summary/rtx3090_pairv2b_20260714_power_api_audit.csv`
- total rows: 60
...
| value | rows |
|---|---:|
| `nvml_total_energy` | 60 |

## Integration Method Counts

| value | rows |
|---|---:|
| `total_energy_mj_delta` | 60 |

## Measurement Scope Counts

| value | rows |
|---|---:|
| `gpu_device_total_energy_counter` | 60 |
...
|---|---:|---:|---:|
| `results/raw/rtx3090_pairv2b_20260714_l1.csv` | 30 | 0 | 0 |
| `results/raw/rtx3090_pairv2b_20260714_shared.csv` | 30 | 0 | 0 |
