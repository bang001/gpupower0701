...
- detail CSV: `results/summary/rtx3090_finalplan_stability_power_api_audit_20260708.csv`
- total rows: 102
...
| value | rows |
|---|---:|
| `nvml_total_energy` | 102 |

## Integration Method Counts

| value | rows |
|---|---:|
| `total_energy_mj_delta` | 102 |

## Measurement Scope Counts

| value | rows |
|---|---:|
| `gpu_device_total_energy_counter` | 102 |
...
|---|---:|---:|---:|
| `results/raw/rtx3090_finalplan_stability_dram_20260708_stability.csv` | 18 | 0 | 0 |
| `results/raw/rtx3090_finalplan_stability_l1_20260708_stability.csv` | 18 | 0 | 0 |
| `results/raw/rtx3090_finalplan_stability_l2_20260708_stability.csv` | 18 | 0 | 0 |
| `results/raw/rtx3090_finalplan_stability_shared_20260708_stability.csv` | 18 | 0 | 0 |
| `results/raw/rtx3090_finalplan_stability_tensor_20260708_stability.csv` | 30 | 0 | 0 |
