...
- detail CSV: `results/summary/rtx3090_shared_paired_lr16_30s_combined_power_api_audit_20260708.csv`
- total rows: 36
...
| value | rows |
|---|---:|
| `nvml_total_energy` | 36 |

## Integration Method Counts

| value | rows |
|---|---:|
| `total_energy_mj_delta` | 36 |

## Measurement Scope Counts

| value | rows |
|---|---:|
| `gpu_device_total_energy_counter` | 36 |
...
|---|---:|---:|---:|
| `results/raw/rtx3090_shared_paired_lr16_30s_stability_20260708.csv` | 18 | 0 | 0 |
| `results/raw/rtx3090_shared_paired_lr16_30s_stability_rerun2_20260708.csv` | 18 | 0 | 0 |
