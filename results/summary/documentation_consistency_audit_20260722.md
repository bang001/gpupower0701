...
|---|---|---|---|---|
| links | `active_markdown_local_links` | **pass** | checked=115 | `README.md;SKILL.md;docs/**/*.md` |
...
| policy | `required_terms:docs/audits/multigpu_sweep_pairing_identity_fix_20260716_ko.md` | **pass** | all present | `docs/audits/multigpu_sweep_pairing_identity_fix_20260716_ko.md` |
