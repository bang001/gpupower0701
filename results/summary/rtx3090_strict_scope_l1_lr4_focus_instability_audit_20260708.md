...
- matched-control detail: `results/summary/rtx3090_strict_scope_l1_lr4_focus_matched_control_detail_20260708.csv`
- audit CSV: `results/summary/rtx3090_strict_scope_l1_lr4_focus_instability_audit_20260708.csv`
...
|---|---|---:|---|---:|---:|---:|---|
| `global_l1_hit_path` | `stable_detail_rows` | 6/6 | - | 343.629401532 | 0.0362309362688 | 0.17348298164 | no_followup_required_by_detail_rows |
