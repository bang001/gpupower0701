...
- detail CSV: `results/summary/rtx3090_component_finalplan_20260714_schema_smoke_power_api_audit.csv`
- total rows: 3
...
|---|---:|---:|---:|
| `results/raw/rtx3090_component_finalplan_20260714_schema_smoke.csv` | 3 | 0 | 0 |
