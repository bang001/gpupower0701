...
- matched-control detail: `results/summary/rtx3090_shared_duration_scaling_matched_control_detail_20260708.csv`
- audit CSV: `results/summary/rtx3090_shared_duration_scaling_instability_audit_20260708.csv`
...
|---|---|---:|---|---:|---:|---:|---|
| `shared_l1_scalar_path` | `stable_detail_rows` | 15/15 | - | 231.909604588 | 0.0331772253789 | 0.198266875816 | no_followup_required_by_detail_rows |
