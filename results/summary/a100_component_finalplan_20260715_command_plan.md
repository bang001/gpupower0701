...
| NCU sudo fallback | `NCU_USE_SUDO=1 bash results/summary/a100_component_finalplan_20260715_commands.sh` |
...
| generated shell | `results/summary/a100_component_finalplan_20260715_commands.sh` |
...
```bash
bash results/summary/a100_component_finalplan_20260715_commands.sh
```
...
```bash
NCU_USE_SUDO=1 bash results/summary/a100_component_finalplan_20260715_commands.sh
```
...
```bash
NCU_BIN="$(command -v ncu)" NCU_USE_SUDO=1 NCU_SUDO="sudo -E" bash results/summary/a100_component_finalplan_20260715_commands.sh
```
