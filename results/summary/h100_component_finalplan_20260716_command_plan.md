...
| generated shell | `results/summary/h100_component_finalplan_20260716_commands.sh` |
...
prints `REAL GPU CALIBRATION: profile=h100` and
...
```bash
bash results/summary/h100_component_finalplan_20260716_commands.sh
```
...
```bash
NCU_BIN="$(command -v ncu)" NCU_USE_SUDO=1 NCU_SUDO="sudo -E" bash results/summary/h100_component_finalplan_20260716_commands.sh
```
