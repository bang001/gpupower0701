...
| matched summary | `results/summary/rtx3090_l1_60s_stability_matched_control_summary_20260708.csv` |
| matched detail | `results/summary/rtx3090_l1_60s_stability_matched_control_detail_20260708.csv` |
...
|---|---|---:|---|---:|---:|---:|---|---|---|
| `global_l1_hit_path` | `accepted_with_caution` | 0.1191477744 | pJ/bit | 7 | 7 | 3 | `medium` | invalid_detail_rows:1 | - |
