...
| input | path |
|---|---|
| power API audit | `results/summary/rtx3090_targeted_l2_power_api_audit_20260708.csv` |
| NCU acceptance | `results/summary/rtx3090_finalplan_ncu_factor_stability_acceptance_20260708.csv` |
| matched summary | `results/summary/rtx3090_targeted_l2_powerstate_filtered_matched_control_summary_20260708.csv` |
| matched detail | `results/summary/rtx3090_targeted_l2_powerstate_filtered_matched_control_detail_20260708.csv` |
...
|---|---|---:|---|---:|---:|---:|---|---|---|
| `l2_hit_cg_path` | `accepted` | 0.978197461641 | pJ/bit | 30 | 30 | 3 | `medium-high` | - | - |
