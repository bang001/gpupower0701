...
- matched-control detail: `results/summary/rtx3090_shared_paired_lr16_30s_stability_matched_control_detail_20260708.csv`
- audit CSV: `results/summary/rtx3090_shared_paired_lr16_30s_stability_instability_audit_20260708.csv`
...
|---|---|---:|---|---:|---:|---:|---|
| `shared_l1_scalar_path` | `needs_stability_followup` | 5/6 | delta_fraction<0.005:1 | 89.13707547 | 0.00930268058953 | 0.0539936915052 | weak_signal_rerun;increase_seconds_20_to_30;prefer_high_signal_factor_rows;keep_min_delta_and_fraction_gate |
