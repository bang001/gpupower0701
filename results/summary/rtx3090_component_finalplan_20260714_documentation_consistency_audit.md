...
|---|---|---|---|---|
| links | `active_markdown_local_links` | **pass** | checked=90 | `README.md;SKILL.md;docs/**/*.md` |
...
| policy | `current_tensor_revision_v5` | **pass** | all current | `README.md;src/main.cu;scripts/plan_platform_component_experiment.py;docs/platforms/a100_node_experiment_guide_ko.md;docs/platforms/v100_node_experiment_guide_ko.md;docs/platforms/h100_node_experiment_guide_ko.md` |
