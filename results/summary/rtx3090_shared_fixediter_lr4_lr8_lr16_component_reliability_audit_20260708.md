...
| input | path |
|---|---|
| power API audit | `results/summary/rtx3090_shared_fixediter_lr4_lr8_lr16_power_api_audit_20260708.csv` |
| NCU acceptance | `results/summary/rtx3090_finalplan_ncu_factor_stability_acceptance_20260708.csv` |
| matched summary | `results/summary/rtx3090_shared_fixediter_lr4_lr8_lr16_matched_control_summary_20260708.csv` |
| matched detail | `results/summary/rtx3090_shared_fixediter_lr4_lr8_lr16_matched_control_detail_20260708.csv` |
...
|---|---|---:|---|---:|---:|---:|---|---|---|
| `shared_l1_scalar_path` | `accepted_with_caution` | 0.140327428192 | pJ/bit | 8 | 8 | 3 | `medium` | invalid_detail_rows:1 | - |
