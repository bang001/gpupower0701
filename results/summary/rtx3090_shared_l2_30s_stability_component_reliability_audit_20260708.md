...
| input | path |
|---|---|
| power API audit | `results/summary/rtx3090_shared_l2_30s_stability_power_api_audit_20260708.csv` |
| NCU acceptance | `results/summary/rtx3090_finalplan_ncu_factor_stability_acceptance_20260708.csv` |
| matched summary | `results/summary/rtx3090_shared_l2_30s_stability_matched_control_summary_20260708.csv` |
| matched detail | `results/summary/rtx3090_shared_l2_30s_stability_matched_control_detail_20260708.csv` |
...
|---|---|---:|---|---:|---:|---:|---|---|---|
| `l2_hit_cg_path` | `accepted_with_caution` | 1.29763921217 | pJ/bit | 9 | 9 | 3 | `medium-high` | invalid_detail_rows:1 | - |
| `shared_l1_scalar_path` | `accepted_with_caution` | 0.216218484187 | pJ/bit | 9 | 9 | 3 | `medium-high` | invalid_detail_rows:1 | - |
