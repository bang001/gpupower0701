...
| input | path |
|---|---|
| power API audit | `results/summary/rtx3090_shared_fixediter_lr16_focus_power_api_audit_20260708.csv` |
| NCU acceptance | `results/summary/rtx3090_finalplan_ncu_factor_stability_acceptance_20260708.csv` |
| matched summary | `results/summary/rtx3090_shared_fixediter_lr16_focus_matched_control_summary_20260708.csv` |
| matched detail | `results/summary/rtx3090_shared_fixediter_lr16_focus_matched_control_detail_20260708.csv` |
...
|---|---|---:|---|---:|---:|---:|---|---|---|
| `shared_l1_scalar_path` | `accepted` | 0.116939328925 | pJ/bit | 6 | 6 | 3 | `medium` | - | - |
