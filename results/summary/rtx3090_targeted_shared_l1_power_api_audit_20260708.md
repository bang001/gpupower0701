...
- detail CSV: `results/summary/rtx3090_targeted_shared_l1_power_api_audit_20260708.csv`
- total rows: 120
...
| value | rows |
|---|---:|
| `nvml_total_energy` | 120 |

## Integration Method Counts

| value | rows |
|---|---:|
| `total_energy_mj_delta` | 120 |

## Measurement Scope Counts

| value | rows |
|---|---:|
| `gpu_device_total_energy_counter` | 120 |
...
|---|---:|---:|---:|
| `results/raw/rtx3090_targeted_l1_stability_20260708.csv` | 60 | 0 | 0 |
| `results/raw/rtx3090_targeted_shared_stability_20260708.csv` | 60 | 0 | 0 |
