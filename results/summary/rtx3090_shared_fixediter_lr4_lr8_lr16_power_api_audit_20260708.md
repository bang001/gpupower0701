...
- detail CSV: `results/summary/rtx3090_shared_fixediter_lr4_lr8_lr16_power_api_audit_20260708.csv`
- total rows: 27
...
| value | rows |
|---|---:|
| `nvml_total_energy` | 27 |

## Integration Method Counts

| value | rows |
|---|---:|
| `total_energy_mj_delta` | 27 |

## Measurement Scope Counts

| value | rows |
|---|---:|
| `gpu_device_total_energy_counter` | 27 |
...
|---|---:|---:|---:|
| `results/raw/rtx3090_shared_fixediter_lr4_lr8_lr16_20260708.csv` | 27 | 0 | 0 |
