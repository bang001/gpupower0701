...
| goal readiness status | `incomplete` (pass=37, missing=6, fail=0, warning=0) |
...
|---|---|---|---:|---:|---|---|---:|
| `rtx3090` | `one_sec_average` | `pass` | 31/0/0 | 0 | - | `pass` | 4 |
