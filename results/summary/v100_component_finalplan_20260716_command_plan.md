...
| NCU sudo fallback | `NCU_USE_SUDO=1 bash results/summary/v100_component_finalplan_20260716_commands.sh` |
...
| generated shell | `results/summary/v100_component_finalplan_20260716_commands.sh` |
...
prints `REAL GPU CALIBRATION: profile=v100` and
...
```bash
bash results/summary/v100_component_finalplan_20260716_commands.sh
```
...
```bash
NCU_BIN="$(command -v ncu)" NCU_USE_SUDO=1 NCU_SUDO="sudo -E" bash results/summary/v100_component_finalplan_20260716_commands.sh
```
