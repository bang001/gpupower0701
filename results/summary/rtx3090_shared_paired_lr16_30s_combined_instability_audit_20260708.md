...
- matched-control detail: `results/summary/rtx3090_shared_paired_lr16_30s_combined_matched_control_detail_20260708.csv`
- audit CSV: `results/summary/rtx3090_shared_paired_lr16_30s_combined_instability_audit_20260708.csv`
...
|---|---|---:|---|---:|---:|---:|---|
| `shared_l1_scalar_path` | `needs_stability_followup` | 11/12 | delta_fraction<0.005:1 | 107.926246112 | 0.0109155576684 | 0.0635455711209 | weak_signal_rerun;increase_seconds_20_to_30;prefer_high_signal_factor_rows;keep_min_delta_and_fraction_gate |

## Invalid Coordinates

| component | invalid coordinates |
|---|---|
| `shared_l1_scalar_path` | W=64KiB,B/SM=16,RF=1,LR=16,delta_E=28.72J,frac=0.002922 |
