...
| item | value |
|---|---|
| raw CSVs | `results/raw/rtx3090_shared_paired_lr16_60s_stability_20260708.csv` |
...
| power-state audit CSVs | `results/summary/rtx3090_shared_paired_lr16_60s_stability_power_state_audit_20260708.csv` |
| min elapsed (s) | 1 |
...
|---|---:|---|---:|---:|---|---|---|---|---:|---:|---:|---:|---:|---:|---:|---|---:|---|---|
| shared_l1_scalar_path | 5 | low | 5 | 0 | nvml_total_energy | total_energy_mj_delta | one_sec_average | pJ/byte | 0.335609 | 0.61455 | 0.610825 | 0.848852 | 0.219704 | 0.346713 | 0.357504 | 0.335609 - 0.848852 | 0.0768187 | 0.0419512 - 0.106107 | 0.0419512 - 0.106107 |
...
|---|---:|---:|---:|---:|---|---|---:|---:|---:|---|---|---|---|---:|---|---:|---:|---|---|
| shared_l1_scalar_path | 64 | 16 | 1 | 16 | shared_scalar_load_only_minus_clocked_empty | nearest-control | 81.1468 | 0.00439364 | 3.75698e+14 | ncu_actual_exact | nvml_total_energy | total_energy_mj_delta | one_sec_average | 0.215989 | pJ/byte | 0.0269987 | 1.06105 | False | delta_fraction<0.005 |
| shared_l1_scalar_path | 64 | 16 | 1 | 16 | shared_scalar_load_only_minus_clocked_empty | nearest-control | 125.842 | 0.00687612 | 3.74967e+14 | ncu_actual_exact | nvml_total_energy | total_energy_mj_delta | one_sec_average | 0.335609 | pJ/byte | 0.0419512 | 1.05711 | True |  |
| shared_l1_scalar_path | 64 | 16 | 1 | 16 | shared_scalar_load_only_minus_clocked_empty | nearest-control | 232.855 | 0.0125259 | 3.78904e+14 | ncu_actual_exact | nvml_total_energy | total_energy_mj_delta | one_sec_average | 0.61455 | pJ/byte | 0.0768187 | 1.06456 | True |  |
| shared_l1_scalar_path | 64 | 16 | 1 | 16 | shared_scalar_load_only_minus_clocked_empty | nearest-control | 173.917 | 0.00929178 | 3.82907e+14 | ncu_actual_exact | nvml_total_energy | total_energy_mj_delta | one_sec_average | 0.454201 | pJ/byte | 0.0567751 | 1.05919 | True |  |
| shared_l1_scalar_path | 64 | 16 | 1 | 16 | shared_scalar_load_only_minus_clocked_empty | nearest-control | 310.523 | 0.0163583 | 3.87711e+14 | ncu_actual_exact | nvml_total_energy | total_energy_mj_delta | one_sec_average | 0.800914 | pJ/byte | 0.100114 | 1.05446 | True |  |
| shared_l1_scalar_path | 64 | 16 | 1 | 16 | shared_scalar_load_only_minus_clocked_empty | nearest-control | 329.874 | 0.0172913 | 3.88611e+14 | ncu_actual_exact | nvml_total_energy | total_energy_mj_delta | one_sec_average | 0.848852 | pJ/byte | 0.106107 | 1.0495 | True |  |
