...
| goal readiness audit | `results/summary/component_energy_goal_readiness_audit_20260716.csv` |
| goal readiness status | `incomplete` (pass=36, missing=7, fail=0, warning=0) |
...
|---|---|---|---:|---:|---|---|---:|
| `rtx3090` | `one_sec_average` | `missing_audit` | 0/0/0 | 0 | - | `missing_summary` | 0 |
