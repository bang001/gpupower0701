...
| input | path |
|---|---|
| power API audit | `results/summary/rtx3090_shared_paired_lr16_30s_combined_power_api_audit_20260708.csv` |
| NCU acceptance | `results/summary/rtx3090_finalplan_ncu_factor_stability_acceptance_20260708.csv` |
| matched summary | `results/summary/rtx3090_shared_paired_lr16_30s_combined_matched_control_summary_20260708.csv` |
| matched detail | `results/summary/rtx3090_shared_paired_lr16_30s_combined_matched_control_detail_20260708.csv` |
...
|---|---|---:|---|---:|---:|---:|---|---|---|
| `shared_l1_scalar_path` | `accepted_with_caution` | 0.0635455711209 | pJ/bit | 11 | 11 | 3 | `medium` | invalid_detail_rows:1 | - |
