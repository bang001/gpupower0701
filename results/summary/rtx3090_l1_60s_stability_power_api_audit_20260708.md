...
- detail CSV: `results/summary/rtx3090_l1_60s_stability_power_api_audit_20260708.csv`
- total rows: 16
...
| value | rows |
|---|---:|
| `nvml_total_energy` | 16 |

## Integration Method Counts

| value | rows |
|---|---:|
| `total_energy_mj_delta` | 16 |

## Measurement Scope Counts

| value | rows |
|---|---:|
| `gpu_device_total_energy_counter` | 16 |
...
|---|---:|---:|---:|
| `results/raw/rtx3090_l1_60s_stability_20260708.csv` | 16 | 0 | 0 |
