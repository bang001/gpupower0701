...
| `raw` | `raw_energy_power_policy` | `missing` | raw rows use target profile metadata, target active SM, total-energy delta, GPU/device scope, explicit measurement_scope, profile power semantics, positive counter delta, elapsed time, and iteration count | no_raw_rows_read | `results/raw/v100_component_finalplan_20260708_tensor.csv;results/raw/v100_component_finalplan_20260708_shared.csv;results/raw/v100_component_finalplan_20260708_l1.csv;results/raw/v100_component_finalplan_20260708_l2.csv;results/raw/v100_component_finalplan_20260708_dram.csv` | copy raw energy CSVs from the target node |
