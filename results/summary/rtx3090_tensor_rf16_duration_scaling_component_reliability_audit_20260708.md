...
| input | path |
|---|---|
| power API audit | `results/summary/rtx3090_tensor_rf16_duration_scaling_power_api_audit_20260708.csv` |
| NCU acceptance | `results/summary/rtx3090_finalplan_ncu_factor_stability_acceptance_20260708.csv` |
| matched summary | `results/summary/rtx3090_tensor_rf16_duration_scaling_matched_control_summary_20260708.csv` |
| matched detail | `results/summary/rtx3090_tensor_rf16_duration_scaling_matched_control_detail_20260708.csv` |
...
|---|---|---:|---|---:|---:|---:|---|---|---|
| `tensor_mma_increment` | `accepted` | 0.076646580102 | pJ/FLOP | 15 | 0 | 10 | `medium-high` | - | - |
