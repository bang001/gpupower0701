...
| input | path |
|---|---|
| power API audit | `results/summary/rtx3090_strict_scope_l1_lr4_lr8_focus_power_api_audit_20260708.csv` |
| NCU acceptance | `results/summary/rtx3090_finalplan_ncu_factor_stability_acceptance_20260708.csv` |
| matched summary | `results/summary/rtx3090_strict_scope_l1_lr4_lr8_focus_matched_control_summary_20260708.csv` |
| matched detail | `results/summary/rtx3090_strict_scope_l1_lr4_lr8_focus_matched_control_detail_20260708.csv` |
...
|---|---|---:|---|---:|---:|---:|---|---|---|---|
| `global_l1_hit_path` | `accepted_low_stability` | 0.147311457312 | pJ/bit | 4 | 4 | 3 | `gpu_device_total_energy_counter` | `low` | low_stability;invalid_detail_rows:2 | - |
