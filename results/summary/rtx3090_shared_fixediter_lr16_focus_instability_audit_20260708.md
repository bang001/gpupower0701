...
- matched-control detail: `results/summary/rtx3090_shared_fixediter_lr16_focus_matched_control_detail_20260708.csv`
- audit CSV: `results/summary/rtx3090_shared_fixediter_lr16_focus_instability_audit_20260708.csv`
...
|---|---|---:|---|---:|---:|---:|---|
| `shared_l1_scalar_path` | `stable_detail_rows` | 6/6 | - | 341.865392406 | 0.0197390263752 | 0.116939328925 | no_followup_required_by_detail_rows |
