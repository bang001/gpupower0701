...
- detail CSV: `results/summary/rtx3090_shared_paired_lr16_30s_stability_rerun2_power_api_audit_20260708.csv`
- total rows: 18
...
| value | rows |
|---|---:|
| `nvml_total_energy` | 18 |

## Integration Method Counts

| value | rows |
|---|---:|
| `total_energy_mj_delta` | 18 |

## Measurement Scope Counts

| value | rows |
|---|---:|
| `gpu_device_total_energy_counter` | 18 |
