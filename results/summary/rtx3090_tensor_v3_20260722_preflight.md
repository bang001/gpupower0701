...
- `memory.total`: 24576
- `power.draw`: 16.82
- `power.draw.average`: 16.82
- `power.draw.instant`: 17.80
- `power.limit`: 370.00
- `clocks.sm`: 210
- `clocks.mem`: 405
- `temperature.gpu`: 41
...
```text
GPU Power Readings
Average Power Draw                             : 17.00 W
Instantaneous Power Draw                       : 17.65 W
...
reuse_factor=1
issue_match_steps=1
issue_match_extra_period=0
latency_match_ns=0
latency_match_period=1
scheduler_match_steps=1
idle_settle_seconds=0
idle_measure_seconds=0
idle_ready_max_power_w=0
idle_ready_consecutive_samples=3
idle_ready_poll_seconds=0.5
idle_ready_timeout_seconds=120
skip_idle_baseline=0
load_repeat=1
store_repeat=1
...
reason=W_SM + B KiB fits rtx3090 shared memory capacity; accessed full-GPU working set also fits nominal L2
W_block_KiB=4
tiles_per_block=4
full_gpu_working_set_MiB=5.125
full_gpu_accessed_working_set_MiB=5.125
accessed_L2_capacity_fraction_pct=85.4167
```
