...
| item | value |
|---|---|
| raw CSVs | `results/raw/rtx3090_shared_paired_lr8_30s_stability_20260708.csv` |
...
| power-state audit CSVs | `results/summary/rtx3090_shared_paired_lr8_30s_stability_power_state_audit_20260708.csv` |
| min elapsed (s) | 10 |
...
|---|---:|---|---:|---:|---|---|---|---|---:|---:|---:|---:|---:|---:|---:|---|---:|---|---|
| shared_l1_scalar_path | 6 | medium | 6 | 0 | nvml_total_energy | total_energy_mj_delta | one_sec_average | pJ/byte | 0.714831 | 1.29605 | 1.21151 | 1.43896 | 0.270515 | 0.234351 | 0.208723 | 0.910631 - 1.42784 | 0.162006 | 0.0893538 - 0.17987 | 0.113829 - 0.17848 |
