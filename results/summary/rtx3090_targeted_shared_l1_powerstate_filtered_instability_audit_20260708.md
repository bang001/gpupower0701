...
- matched-control detail: `results/summary/rtx3090_targeted_shared_l1_powerstate_filtered_matched_control_detail_20260708.csv`
- audit CSV: `results/summary/rtx3090_targeted_shared_l1_powerstate_filtered_instability_audit_20260708.csv`
...
|---|---|---:|---|---:|---:|---:|---|
| `global_l1_hit_path` | `needs_stability_followup` | 26/28 | delta_E<10J:1;delta_fraction<0.005:2;negative_coefficient:2 | 139.234818505 | 0.0230982689244 | 0.104689502947 | targeted_stability_rerun;use_longer_seconds_20_to_30;increase_repeats_10_or_more;keep_power_api_audit;inspect_control_drift_and_temperature_clock;do_not_relax_delta_gate |
...
|---|---|
| `global_l1_hit_path` | W=16KiB,B/SM=16,RF=1,LR=16,delta_E=-6.857J,frac=-0.001108 | W=16KiB,B/SM=16,RF=1,LR=16,delta_E=-15.67J,frac=-0.002629 |
