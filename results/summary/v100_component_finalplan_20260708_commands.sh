...
# Generated for v100 on 2026-07-09.
# Volta path. Use an NCU toolchain whose --list-chips includes gv100.
mkdir -p results/raw results/summary results/ncu

# 1. Preflight
python3 scripts/preflight_gpu_support.py --gpu 0 --target-profile v100 --strict --active-sm 80 --binary ./build-v100/a100_fp16_energy_v2 --ncu ncu --out results/summary/v100_component_finalplan_20260708_preflight.md
