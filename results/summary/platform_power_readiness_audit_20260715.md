...
- detail CSV: `results/summary/platform_power_readiness_audit_20260715.csv`
- checks: 125
- failures: 0
...
| `plan_blocks` | `pass` | `16` | `16` |
| `plan_tensor_blocks` | `pass` | `4,16,32` | `4,16,32` |
| `plan_ncu_blocks` | `pass` | `16` | `16` |
| `plan_shared_w` | `pass` | `128` | `128` |
| `plan_shared_ncu_w` | `pass` | `128` | `128` |
| `plan_l1_w` | `pass` | `16` | `16` |
| `plan_l1_ncu_w` | `pass` | `16` | `16` |
| `plan_l2_w` | `pass` | `16,128` | `16,128` |
| `plan_l2_ncu_w_values` | `pass` | `16,128` | `16,128` |
| `plan_dram_w` | `pass` | `2048,4096,8192` | `2048,4096,8192` |
| `plan_memory_energy_load_repeats` | `pass` | `4,8,16` | `4,8,16` |
...
| `plan_l1_w` | `pass` | `16` | `16` |
| `plan_l1_ncu_w` | `pass` | `16` | `16` |
| `plan_l2_w` | `pass` | `64,128` | `64,128` |
| `plan_l2_ncu_w_values` | `pass` | `64,128` | `64,128` |
| `plan_dram_w` | `pass` | `2048,4096,8192` | `2048,4096,8192` |
| `plan_memory_energy_load_repeats` | `pass` | `4,8,16` | `4,8,16` |
...
| `plan_power_semantics` | `pass` | `one_sec_average` | `one_sec_average` |
| `plan_blocks` | `pass` | `8` | `8` |
| `plan_tensor_blocks` | `pass` | `4,8,16` | `4,8,16` |
| `plan_ncu_blocks` | `pass` | `8` | `8` |
| `plan_shared_w` | `pass` | `64` | `64` |
| `plan_shared_ncu_w` | `pass` | `64` | `64` |
| `plan_l1_w` | `pass` | `8` | `8` |
| `plan_l1_ncu_w` | `pass` | `8` | `8` |
| `plan_l2_w` | `pass` | `32,64` | `32,64` |
| `plan_l2_ncu_w_values` | `pass` | `32,64` | `32,64` |
| `plan_dram_w` | `pass` | `256,512,2048` | `256,512,2048` |
| `plan_memory_energy_load_repeats` | `pass` | `4,8,16` | `4,8,16` |
...
| `plan_power_semantics` | `pass` | `instant` | `instant` |
| `plan_blocks` | `pass` | `32` | `32` |
| `plan_tensor_blocks` | `pass` | `4,16,32` | `4,16,32` |
| `plan_ncu_blocks` | `pass` | `32` | `32` |
| `plan_shared_w` | `pass` | `32` | `32` |
| `plan_shared_ncu_w` | `pass` | `32` | `32` |
| `plan_l1_w` | `pass` | `32` | `32` |
