...
| matched summary | `results/summary/rtx3090_targeted_shared_l1_powerstate_filtered_matched_control_summary_20260708.csv` |
| matched detail | `results/summary/rtx3090_targeted_shared_l1_powerstate_filtered_matched_control_detail_20260708.csv` |
...
|---|---|---:|---|---:|---:|---:|---|---|---|
| `global_l1_hit_path` | `accepted_with_caution` | 0.104689502947 | pJ/bit | 26 | 26 | 3 | `medium` | invalid_detail_rows:2 | - |
