...
```bash
bash results/summary/a100_component_finalplan_20260714_commands.sh
```
...
```bash
NCU_USE_SUDO=1 bash results/summary/a100_component_finalplan_20260714_commands.sh
```
...
```bash
NCU_BIN="$(command -v ncu)" NCU_USE_SUDO=1 NCU_SUDO="sudo -E" bash results/summary/a100_component_finalplan_20260714_commands.sh
```
