...
| NCU | `/home/bang001/miniforge3/envs/ssc21env/nsight-compute-2026.1.1/ncu` |
...
| NCU sudo fallback | `NCU_USE_SUDO=1 bash results/summary/rtx3090_component_finalplan_20260714_rerun1_commands.sh` |
| generated shell | `results/summary/rtx3090_component_finalplan_20260714_rerun1_commands.sh` |
...
|---|---|---:|---:|---|
| Tensor | `reg_operand_only,reg_mma` | 2048 | 2048/8 | reuse 1,2,4,8,16; treatment/control-floor dual-calibrated pair-locked ITER |
| Shared scalar | `clocked_empty,shared_scalar_load_only` | 32,64 | 64/8 | energy load_repeat 4,8,16; NCU also checks 1,2 |
| Global L1 | `global_addr_only,global_l1_load_only` | 8,16 | 8/8 | energy load_repeat 4,8,16; NCU also checks 1,2 |
| L2 | `global_addr_only,l2_cg_load_only` | 64 | 64/8 | energy load_repeat 4,8,16; treatment/control-floor dual-calibrated pair-locked ITER; NCU also checks 1,2 |
| DRAM sanity | `global_addr_only,dram_cg_load_only` | 8192 | 8192/8 | energy load_repeat 4,8,16; treatment/control-floor dual-calibrated pair-locked ITER; NCU checks 1,4,8,16 |
...
`W8/B8,W16/B8,W16/B16`. Coordinates omitted before execution because
`W_SM < blocks/SM` are `W8/B16`. The
...
W_SM=64 KiB as the strict L2 path. The generated strict anchor is
...
```bash
bash results/summary/rtx3090_component_finalplan_20260714_rerun1_commands.sh
```
...
```bash
NCU_USE_SUDO=1 bash results/summary/rtx3090_component_finalplan_20260714_rerun1_commands.sh
```
...
```bash
NCU_BIN="$(command -v ncu)" NCU_USE_SUDO=1 NCU_SUDO="sudo -E" bash results/summary/rtx3090_component_finalplan_20260714_rerun1_commands.sh
```
