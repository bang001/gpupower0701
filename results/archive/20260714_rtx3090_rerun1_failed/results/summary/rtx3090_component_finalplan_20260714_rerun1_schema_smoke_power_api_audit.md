...
- detail CSV: `results/summary/rtx3090_component_finalplan_20260714_rerun1_schema_smoke_power_api_audit.csv`
- total rows: 3
...
| value | rows |
|---|---:|
| `total_energy_mj_delta` | 3 |

## Measurement Scope Counts

| value | rows |
|---|---:|
| `gpu_device_total_energy_counter` | 3 |
...
|---|---:|---:|---:|
| `results/raw/rtx3090_component_finalplan_20260714_rerun1_schema_smoke.csv` | 3 | 0 | 0 |
