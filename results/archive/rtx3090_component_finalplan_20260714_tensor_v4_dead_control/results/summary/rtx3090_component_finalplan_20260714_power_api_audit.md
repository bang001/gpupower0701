...
- detail CSV: `results/summary/rtx3090_component_finalplan_20260714_power_api_audit.csv`
- total rows: 360
...
| value | rows |
|---|---:|
| `nvml_total_energy` | 360 |

## Integration Method Counts

| value | rows |
|---|---:|
| `total_energy_mj_delta` | 360 |

## Measurement Scope Counts

| value | rows |
|---|---:|
| `gpu_device_total_energy_counter` | 360 |
...
|---|---:|---:|---:|
| `results/raw/rtx3090_component_finalplan_20260714_dram.csv` | 90 | 0 | 0 |
| `results/raw/rtx3090_component_finalplan_20260714_l1.csv` | 30 | 0 | 0 |
| `results/raw/rtx3090_component_finalplan_20260714_l2.csv` | 60 | 0 | 0 |
| `results/raw/rtx3090_component_finalplan_20260714_shared.csv` | 30 | 0 | 0 |
| `results/raw/rtx3090_component_finalplan_20260714_tensor.csv` | 150 | 0 | 0 |
