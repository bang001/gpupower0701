...
def current_exploratory_origin() -> dict[str, str]:
    ...
    return {
        "manifest_path": relative_or_absolute(EXPLORATORY_MANIFEST),
        "manifest_sha256": sha256_file(EXPLORATORY_MANIFEST),
        "analysis_path": relative_or_absolute(EXPLORATORY_ANALYSIS),
        "analysis_sha256": sha256_file(EXPLORATORY_ANALYSIS),
...
def main(argv: list[str] | None = None) -> int:
    ...
    origin = current_exploratory_origin()
