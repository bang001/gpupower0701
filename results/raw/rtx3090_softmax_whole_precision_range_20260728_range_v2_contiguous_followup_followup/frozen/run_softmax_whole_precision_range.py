...
def parent_binding(parent: str | None) -> dict[str, Any] | None:
    if parent is None:
        return None
...
def plan_run(args: argparse.Namespace) -> Path:
    ...
    sessions = build_sessions(
        ...
        runtime_sm_count=args.runtime_sm_count or profile.full_sm_counts[-1],
    ...
    manifest: dict[str, Any] = {
        ...
        "profile": {
            ...
            "runtime_sm_count_planned": args.runtime_sm_count or profile.full_sm_counts[-1],
        },
        "metric": {
        ...
        "parent": parent_binding(args.continue_from),
